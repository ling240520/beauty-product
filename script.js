...
function render(){
 ...
 const filtered=q||brand!=='全部品牌'||category!=='全部類別'||date!=='全部日期'||activeBenefit!=='全部';$('#clear-filters').hidden=!filtered;
}
...
$('#clear-filters').onclick=()=>{$('#search').value='';$('#brand-filter').value='全部品牌';$('#category-filter').value='全部類別';$('#date-filter').value='全部日期';activeBenefit='全部';renderBenefits();render()};
